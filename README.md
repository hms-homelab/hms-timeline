...
[![GHCR](https://img.shields.io/badge/GHCR-yolo--timeline-blue?logo=github)](https://github.com/hms-homelab/hms-timeline/pkgs/container/yolo-timeline)
...
- Semantic search across AI vision descriptions
...
- `ollama_url` — URL of Ollama instance (for semantic search embeddings)
